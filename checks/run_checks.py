...
PHOTOS = [
    ("L03A_plain", ["L03A"]),
    ("L03A_all_flags", ["L03A", "--hardwalls", "all", "--steps", "all", "--nocollision", "--boxes",
                        "--deathzones", "--teleportzones", "--ground", "--areaboxes", "--faces1000"]),
    ("L03A_skeleton", ["L03A", "--wireframe", "1"]),
    ("L03A_grid", ["L03A", "--wireframe", "2"]),
    ("L03A_clones_psx", ["L03A", "--clones", "2", "--albedo", "2"]),
    ("L03A_walls_close", ["L03A", "--camera", "268,12,-130,160,-15", "--hardwalls", "all", "--steps", "all"]),
    ("L03A_walls_unseen", ["L03A", "--camera", "268,12,-130,160,-15", "--hardwalls", "unseen", "--steps", "unseen"]),
    ("L03A_crates_walls", ["L03A", "--camera", "245.9,20.1,-39.7,180,-15", "--hardwalls", "all", "--steps", "all"]),
    ("L03A2_structures_walls", ["L03A2", "--camera", "224.6,23.4,-23.7,180,-20", "--hardwalls", "all", "--steps", "all"]),
    ...
    ("L03D1_heightmap", ["L03D1", "--ground", "--hardwalls", "all", "--areaboxes"]),
    ...
    ("L04E_step_walls", ["L04E", "--camera", "168,54,-97.3,0,-8", "--steps", "all"]),
    ("LS01_step_both_sides", ["LS01", "--camera", "64.38,153,-142.5,-90,-68", "--steps", "all"]),
    ("L05A1_hole_steps", ["L05A1", "--steps", "all", "--hole-steps"]),
