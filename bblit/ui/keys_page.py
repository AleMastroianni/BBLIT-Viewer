...
from ui import keybinds as kb
from ui.menu import (BACKGROUND_COLOR, DESCRIPTION_COLOR, FONT, HIGHLIGHT_COLOR, SELECTED_TEXT_COLOR,
                  TEXT_COLOR, TITLE_COLOR, ellipsize, wrap_lines)
from ui.texts import language, t
