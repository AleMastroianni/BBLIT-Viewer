"""Moved to `bblit/game/loadscript.py`.

This file only keeps `import loadscript` working for the reverse engineering
...
sys.modules[__name__] = importlib.import_module("game.loadscript")
