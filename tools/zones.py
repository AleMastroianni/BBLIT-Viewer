"""Moved to `bblit/game/zones.py`.

This file only keeps `import zones` working for the reverse engineering
...
sys.modules[__name__] = importlib.import_module("game.zones")
